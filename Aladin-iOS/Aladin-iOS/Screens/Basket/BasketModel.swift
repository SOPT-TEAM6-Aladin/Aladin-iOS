...
let basketDummy : [BasketModel] = [
    ...
    BasketModel(image: UIImage(named: "book_image2"), name: "피아노 치는 할머니가 될래", price: "14,400원", quantity: "1", deliveryInfo: "11월 7일(월) 밤 11시 잠들기전 배송", ischecked: false),
        BasketModel(image: UIImage(named: "book_image1"), name: "기소영의 친구들2", price: "20,800원", quantity: "1", deliveryInfo: "11월 8일(화) 아침 11시전 배송", ischecked: true),
    BasketModel(image: UIImage(named: "book_image2"), name: "피아노 치는 할아버지가 될래", price: "18,400원", quantity: "1", deliveryInfo: "11월 8일(화) 아침 11시전 배송", ischecked: false)
]
